...
export function P3bRetos() {
  return (
    <div className="relative flex h-full flex-col text-white" style={GRADIENT_BG}>
      ...
      {/* White content sheet */}
      <div className="flex flex-1 flex-col overflow-y-auto rounded-t-3xl bg-background px-6 pb-48 pt-6 text-on-text animate-in fade-in duration-500 ease-out">
      ...
      <div className="absolute inset-x-0 bottom-0 animate-in fade-in slide-in-from-bottom-8 delay-500 duration-700 ease-out fill-mode-both">
